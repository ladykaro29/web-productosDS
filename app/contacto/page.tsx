        ...
        <main className="min-h-screen bg-ds-light overflow-x-hidden">
            ...
            <section className="relative pt-32 pb-20 px-4 bg-ds-dark text-white overflow-hidden">
                ...
                <div className="container mx-auto relative z-10 text-center">
                    ...
                    >
                        Hablemos de <span className="text-ds-red">Sabor</span>
                    </h1>
                    <p
                        className="text-xl text-gray-300 max-w-3xl mx-auto animate-fade-in-up delay-200"
                    >
                        ¿Tienes dudas, sugerencias o quieres distribuir nuestros productos? Escríbenos, nos encanta escucharte.
                    </p>
                </div>
            </section>

            <div className="pt-10"> {/* Adjusted padding */}
                <Contact />
            </div>
            <Footer />
        </main>
