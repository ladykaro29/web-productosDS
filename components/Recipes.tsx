...
const recipes = [
    {
        ...
        image: "/products/platanos-picante-final.png", // Using product image as base
        color: "bg-ds-red",
        prepTime: "10 min",
        servings: "4 personas",
        ingredients: [
    ...
    },
    {
        ...
        description: "Un toque gourmet y refrescante usando nuestras Yummi Yucas.",
        image: "/products/yuca-limon.png",
        color: "bg-ds-yellow",
        prepTime: "15 min",
        servings: "3 personas",
        ingredients: [
            "1 bolsa de Yummi Yucas Limón",
        ...
        steps: [
            ...
            "Sirve sobre una cama de Yummi Yucas.",
...
const Recipes = () => {
    ...
    return (
        <section className="py-24 bg-white relative overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 w-96 h-96 bg-ds-red/5 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2"></div>
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                        Ideas rápidas y divertidas para ser el alma de la fiesta con Productos DS.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {recipes.map((recipe, index) => (
                        <motion.div
                            ...
                            onClick={() => setActiveId(activeId === recipe.id ? null : recipe.id)} // Mobile toggle
                        >
                            <div className={`relative w-full h-full transition-all duration-700 preserve-3d ${activeId === recipe.id ? 'rotate-y-180' : ''}`}>
                                ...
                                <div className="absolute inset-0 w-full h-full backface-hidden rotate-y-180 rounded-[2rem] overflow-hidden shadow-xl bg-white border-2 border-gray-100 p-8 flex flex-col text-ds-dark">
                                    ...
                                    <div className="mt-auto text-center pt-4">
                                        <span className="text-xs text-gray-400 font-medium uppercase tracking-widest">¡Comparte tu foto! 📸</span>
                                    </div>
                                </div>
